   ...
   {{-- <section>
    ...
    <section class="mt-5">
            <div class="container">
                <div class="row ">
                  <div class="col">
                    <div class="col px-4" style="position: sticky;   top: 14%;">
                        <h2>
                            Kids Crackers
                        </h2>
                         <div >
                            <a  class="dropdown-item fs-5"href="#section-1" style="color:#63459B ">11/2 Twinkling Star</a>
                            <a class="dropdown-item fs-5" href="#" style="color:#63459B ">4" Twinkling Star</a>
                            <a class="dropdown-item fs-5" href="#" style="color:#63459B ">Magic pops</a>
                            <a class="dropdown-item fs-5" href="#" style="color:#63459B ">Ultra Candle</a>
                            <a class="dropdown-item fs-5" href="#" style="color:#63459B ">Zee Boom Baa</a>
                  ...
                  <div class="col">
                    <div class="">
                        <div class="card p-4 ">
                            <div class="text-center">
                                <a href="/kid-gun-2"><img src="image/gallery/kids-gun-ps.jpg" width="200"></a> 
                            </div>
                            <div class="product-details">
                                <span class="font-weight-bold" style="display: flex; justify-content: space-around; margin-top:10px">Kisd Gun</span>
                            <span class="font-weight-bold" style="display: flex; justify-content: space-around; margin-top:10px">RS. 0.00</span>
                    ...
                    <div class="mt-3"  id="section-1">
                        <div class="card p-4 ">
                            <div class="text-center">
                                <a href="/kid-gun-2"><img src="image/gallery/kids-gun-ps.jpg" width="200"></a> 
                            </div>
                            <div class="product-details">
                                <span class="font-weight-bold" style="display: flex; justify-content: space-around; margin-top:10px">Ki Gun</span>
                            <span class="font-weight-bold" style="display: flex; justify-content: space-around; margin-top:10px">RS. 0.00</span>
                                <div class="buttons d-flex flex-row">
                                    <div class="cart"><i class="fa fa-shopping-cart"></i></div> <button
                                        class="btn btn-warning cart-button btn-block"><span class="dot">1</span>Add to
