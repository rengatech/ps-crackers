...
<div class="container mt-5" style="margin-bottom:200px">
  <div class="row">
    ...
    <div class="col-lg-5 mt-5">
      <h6>Old password</h6>
    <input type="password" id="inputPassword6" class="form-control" placeholder="" aria-describedby="passwordHelpInline">
  </div>
  <div class="col-lg-5 mt-3">
    <h6>New password</h6>
  <input type="password" id="inputPassword6" class="form-control" placeholder="" aria-describedby="passwordHelpInline">
  </div>
  <button type="button" class="btn btn-lg  mt-4  text-center" style="background-color:#63459B; color:#fff" >Change Password</button>
