...
<?php include('navbar.php');?>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-5">
                <div class="main-img">
                <img class="img-fluid" src="image/rockets/rocket-4.jpg" >
                    
                    <div class="row my-3 previews">
                        <div class="col-md-3">
                    
                            <img class="w-100" src="image/rockets/rocket-2.jpg" >
                        </div>
                        <div class="col-md-3">
                        <img class="w-100" src="image/rockets/rocket-7.jpg" >
                        </div>
                        <div class="col-md-3">
                        <img class="w-100" src="image/rockets/rocket-5.jpg" >
                        </div>
                        <div class="col-md-3">
                        <img class="w-100" src="image/rockets/rocket-6.jpg" >
                        </div>
                    </div>
                </div>
            </div>
